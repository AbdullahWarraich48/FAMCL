...
export const BookKeepingHerosection = ({
  ...
  return (
    ...
    >
      <div className="content-padding-x mx-auto max-w-[1440px] py-12 md:py-16 lg:py-20">
        {/* Two-column hero */}
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_1fr] lg:gap-14 lg:items-start">
          ...
          <div className="flex flex-col">
            ...
            <h1 className="mt-6 text-[2.25rem] font-bold leading-[1.1] tracking-tight text-[#1e3a5f] sm:text-4xl lg:text-[44px] lg:leading-[1.1]">
              {hero.heading}
            </h1>
            ...
            <p
              className="mt-4 max-w-xl text-[18px] leading-[27.8px] text-slate-700"
  ...
  {/* Background Shape */}
  <div className="absolute -bottom-6 -left-6 h-full w-full rounded-2xl bg-blue-100"></div>

  {/* Image Card */}
  <div className="relative h-[280px] overflow-hidden rounded-2xl bg-slate-100 shadow-[0_30px_80px_rgba(15,23,42,0.55)] ring-1 ring-slate-200/60 sm:h-[320px] md:h-[360px] lg:h-[420px]">
    <Image
      src={hero.image.src}
      alt={hero.image.alt}
      width={600}
