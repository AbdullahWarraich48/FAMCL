...
import {
  LIMITED_COMPANIES_SOLUTION_DATA,
  LIMITED_COMPANIES_TRUST_MATRIX_SOLUTION_DATA,
} from "@/data/limitedCompanies/solutionData";
...
export const metadata = {
  ...
  description:
    "Structure, clarity, and room to grow. Accounting, tax, and compliance support for UK limited companies with director responsibility and risk control.",
};
...
export default function LimitedCompaniesPage() {
  return (
    <main className="min-h-screen bg-white">
      ...
      <Facts data={LIMITED_COMPANIES_FACTS_DATA} sectionClassName={SECTION_BG.white} />
      <Solution data={LIMITED_COMPANIES_SOLUTION_DATA} sectionClassName={SECTION_BG.alt} />
      <LimitedCompaniesChallenges />
      <LimitedCompaniesChooseService />
      <Solution data={LIMITED_COMPANIES_TRUST_MATRIX_SOLUTION_DATA} />
